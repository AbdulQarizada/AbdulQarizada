...
<?php $__env->startSection('title'); ?> Jobs Management <?php $__env->stopSection(); ?>
...
<div class="row mt-4">
    <div class="col-4">
        <a href="<?php echo e(route('IndexAbdulWahabQarizada')); ?>" class="btn btn-info btn-lg waves-effect mb-3 btn-label waves-light"><i class="bx bx-left-arrow  font-size-16 label-icon"></i>Back</a>
